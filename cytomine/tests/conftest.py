...
def dataset(request):
    ...
    data["term"] = Term(random_string(), data["ontology"].id, "#000000").save()
    ...
    data["annotation"] = Annotation("POLYGON ((0 0, 0 20, 20 20, 20 0, 0 0))", data["image_instance"].id, [data["term"].id]).save()
